...
pipeline = joblib.load(os.path.join(APP_DIR, "risk_model.joblib"))   # loading the trained model   # loading the trained model
...
background_sample = joblib.load(os.path.join(APP_DIR, "shap_background.joblib"))
